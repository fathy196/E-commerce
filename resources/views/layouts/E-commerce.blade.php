        ...
        <div class="menu-push">
            ...
            <form role="search" method="get" id="searchform" class="searchform" action="/search">
                <div>
                    ...
                    <input type="text" placeholder="Search for products" value="" name="q" id="q"
                        autocomplete="off">
            ...
            <ul class="nav-home5 js-menubar">
                    ...
                    <div class="menu-level1 js-open-menu">
                        <ul class="level1">
                            ...
                            <li class="level2">
                                <a href="#">Categories</a>
                                <ul class="menu-level-2">
                                    <li class="level3"><a href="cat_left_sidebar.html" title="">Categories Left
                                            Sidebar</a></li>
                                </ul>
                            </li>
                            <li class="level2">
                            ...
                            <li class="level2">
                                ...
                                <ul class="menu-level-2">
                                    <li class="level3"><a href="product_extended.html" title="">Product
                                            Extended</a></li>
                                </ul>
                            </li>
                            <li class="level2">
                ...
                <li class="level1">
                    ...
                    <ul class="menu-level1 js-open-menu">
                        ...
                        <li class="level2"><a href="blog-single-post.html" title="Blog Single Post">Blog Single
                                Post</a></li>
                    </ul>
                </li>

                {{-- if user doesnt log in --}}
                @guest
                    @if (Route::has('login'))
                        <li class="level1">
                ...
                @else
                    ...
                    <li class="level1"><a class="dropdown-item" href="{{ route('logout') }}"
                            ...
                            <div class="col-lg-3  col-md-3 col-sm-6 col-xs-6 v-center header-sub">
                                <div class="right-panel">
                                    ...
                                    <div class="header-sub-element row">
                                        <a class="hidden-xs hidden-sm" href=""><img
                                                src="{{ asset('assets/img/icon-user.png') }}" alt=""></a>
                                        <a href="#"><img src="{{ asset('assets/img/icon-heart.png') }}"
                                                alt=""></a>
                                        <div class="cart">
                                            ...
                                            <div class="dropdown-menu dropdown-cart">
                                                <ul class="mini-products-list">
                                                    <li class="item-cart">
                                                        <div class="product-img-wrap">
                                                            <a href="#"><img
                                                                    src="{{ asset('assets/img/cart1.jpg') }}"
                                                                    alt="" class="img-reponsive"></a>
                                                        </div>
                                                        <div class="product-details">
                                                            <div class="inner-left">
                                                                <div class="product-name"><a href="#">Harman
                                                                        Kardon Onyx Studio </a></div>
                                                ...
                                                <div class="bottom-cart">
                                                    ...
                                                    <div class="button-cart">
                                                        ...
                                                        <a href="#"
                                                            class="cart-btn e-checkout btn-gradient">Checkout</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-9 widget-left">
                                <div class="flex lr">
                                    <nav class="main-menu flex align-center">
                                        ...
                                        <div class="collapse navbar-collapse" id="myNavbar">
                                            <ul class="nav navbar-nav js-menubar">
                                                ...
                                                <li class="level1 dropdown hassub"><a href="#">Shop<span
                                                    ...
                                                    <div class="menu-level-1 dropdown-menu">
                                                        <ul class="level1">
                                                            <li class="level2 col-4">
                                                                <a href="#">Shop Layout</a>
                                                                <ul class="menu-level-2">
                                                                    <li class="level3"><a href="shopgrid_v2.html"
                                                                            title="">Shop Grid v.2</a><span
                                                                            class="h-ribbon v3 e-red h-pos">Hot</span>
                                                                    </li>
                                                                </ul>
                                                                <a href="#">Categories</a>
                                                                <ul class="menu-level-2">
                                                                    <li class="level3"><a href="cat_left_sidebar.html"
                                                                            title="">Categories Left Sidebar</a>
                                                                    </li>
                                                                </ul>
                                                            </li>
                                                            <li class="level2 col-4">
                                                                ...
                                                                <ul class="menu-level-2">
                                                                    ...
                                                                    <li class="level3"><a href="outofstock.html">Out
                                                                            of stock</a></li>
                                                                    <li class="level3"><a href="onsale.html">On
                                                                            sale</a></li>
                                                                </ul>
                                                            </li>
                                                            <li class="level2 col-4">
                                                                <a href="#">Single Product Layout</a>
                                                                <ul class="menu-level-2">
                                                                    <li class="level3"><a href="product_extended.html"
                                                                            title="">Product Extended</a><span
                                                                            class="h-ribbon v3 e-red h-pos">Hot</span>
                                                                    </li>
                                                                </ul>
                                                                <a href="#">Other Pages</a>
                                                                <ul class="menu-level-2">
                                                                    <li class="level3"><a href="cart.html"
                                                                            title="">Cart</a></li>
                                                                    <li class="level3"><a href="wishlist.html"
                                                                            title="">My Wishlist</a></li>
                                                                    <li class="level3"><a href="checkout.html"
                                                                            title="">Checkout</a></li>
                                                                    <li class="level3"><a href="myaccount.html"
                                                                            title="">My Account</a></li>
                                                                    <li class="level3"><a href="track.html"
                                                                            title="">Track Your Order</a></li>
                                                                </ul>
                                                            </li>
                                                        </ul>
                                                        <div class="clearfix"></div>
                                                ...
                                                <li class="level1 active dropdown">
                                                    <a href="#">Pages<span
                                                            class="h-ribbon h-pos e-skyblue">new</span></a>
                                                    <span class="plus js-plus-icon"></span>
                                                    <ul class="dropdown-menu menu-level-1">
                                                        <li class="level2"><a href="aboutus.html"
                                                                title="About Us ">About Us </a></li>
                                                        <li class="level2"><a href="contactus.html"
                                                                title="Contact">Contact</a></li>
                                                        <li class="level2"><a href="faq.html" title="FAQs">FAQs</a>
                                                        </li>
                                                        <li class="level2"><a href="404.html" title="404">404</a>
                                                        </li>
                                                        <li class="level2"><a href="commingsoon.html"
                                                                title="Coming Soon">Coming Soon</a></li>
                                                    </ul>
                                                </li>
                                                <li class="level1 active dropdown">
                                                    <a href="#">Blog</a>
                                                    <ul class="dropdown-menu menu-level-1">
                                                        <li class="level2"><a href="blog_grid.html"
                                                                title="Blog Gird">Blog Gird</a></li>
                                                        <li class="level2"><a href="blog-single-post.html"
                                                ...
                                                @else
                                                    <li class="level1 active dropdown">
                                                        <a id="navbarDropdown" class="nav-link dropdown-toggle"
                                                            href="dashboard" role="button" data-bs-toggle="dropdown"
                                    ...
                                    <div class="header-bottom-right hidden-xs hidden-sm">
                                        <img src="{{ asset('assets/img/icon-ship.png') }}" alt=""
                                            class="img-reponsive">
