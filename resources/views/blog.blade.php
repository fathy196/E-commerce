...
@section('Content')
        <div class="container container-240">
            <div class="blog-banner pd-banner v2">
               <a href="#" class="effect_img2"><img src="{{ asset('assets/img/blog/blog-banner.png') }}" alt="" class="img-reponsive"></a> 
            </div>
            <div class="blog spc1">
                    ...
                    <div class="row">
                        <div class="blog-content  col-md-9  col-xs-12">
                            <div class="blog-post-item v2">
                                <div class="blog-img">
                                    <a href="#" class="hover-images"><img src="{{ asset('assets/img/blog/single-post.jpg') }}" alt="" class="img-reponsive"></a>
                            ...
                            <div class="blog-comment">
                                <div class="blog-comment-top">
                                    <div class="blog-comment-item">
                                        <div class="cmt-img">
                                            <img src="{{ asset('assets/img/blog/author1.jpg') }}" alt="">
                                        </div>
                                ...
                                <div class="blog-comment-content">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="blog-comment-item">
                                                <div class="cmt-img">
                                                    <img src="{{ asset('assets/img/blog/author2.jpg') }}" alt="">
                                                </div>
                                                <div class="cmt-content">
                                                    <div class="wrp-name">
                                        ...
                                        <li>
                                            <div class="blog-comment-item">
                                                <div class="cmt-img">
                                                    <img src="{{ asset('assets/img/blog/author3.jpg') }}" alt="">
                                                </div>
                                                <div class="cmt-content">
                                                    <div class="wrp-name">
                                                       <div class="wrp-element">
                                        ...
                                        <li>
                                            <div class="blog-comment-item">
                                                <div class="cmt-img">
                                                    <img src="{{ asset('assets/img/blog/author4.jpg') }}" alt="">
                                                </div>
                                                <div class="cmt-content">
                                                    <div class="wrp-name">
                                                        <div class="wrp-element">
                        ...
                        <div class="blog-sidebar col-md-3 col-xs-12">
                            ...
                            <div class="blog-widget blog-widget-popular">
                                ...
                                <div class="owl-carousel owl-theme js-owl-post">
                                    <div class="item">
                                        <div class="post-item">
                                            <div class="post-img">
                                                <img src="{{ asset('assets/img/blog/post1.jpg') }}" alt="">
                                            </div>
                                            <div class="post-info">
                                        ...
                                        <div class="post-item">
                                            <div class="post-img">
                                                <img src="{{ asset('assets/img/blog/post2.jpg') }}" alt="">
                                            </div>
                                            <div class="post-info">
                                                <h3><a href="#">Traveling abroad change you forever</a></h3>
                                                <p>April 30, 2016</p>
                                        ...
                                        <div class="post-item">
                                            <div class="post-img">
                                                <img src="{{ asset('assets/img/blog/post3.jpg') }}" alt="">
                                            </div>
                                            <div class="post-info">
                                                <h3><a href="#">Traveling abroad change you forever</a></h3>
                                                <p>April 30, 2016</p>
                                        ...
                                        <div class="post-item">
                                            <div class="post-img">
                                                <img src="{{ asset('assets/img/blog/post4.jpg') }}" alt="">
                                            </div>
                                            <div class="post-info">
                                                <h3><a href="#">Traveling abroad change you forever</a></h3>
                                                <p>April 30, 2016</p>
                            ...
                            <div class="blog-widget blog-widget-instagram">
                                ...
                                <div class="instagram">
                                    <a href="#" class=""><img src="{{ asset('assets/img/blog/insta_1.jpg') }}" alt="" class="img-reponsive"></a>
                                    <a href="#" class=""><img src="{{ asset('assets/img/blog/insta_2.jpg') }}" alt=""></a>
                                    <a href="#" class=""><img src="{{ asset('assets/img/blog/insta_3.jpg') }}" alt=""></a>
                                    <a href="#" class=""><img src="{{ asset('assets/img/blog/insta_4.jpg') }}" alt=""></a>
                                    <a href="#" class=""><img src="{{ asset('assets/img/blog/insta_5.jpg') }}" alt=""></a>
                                    <a href="#" class=""><img src="{{ asset('assets/img/blog/insta_6.jpg') }}" alt=""></a>
                                </div>
                            </div>
                            <div class="blog-widget-banner">
                                <a href="#" class=""><img src="{{ asset('assets/img/blog/ads.png') }}" alt="" class="img-reponsive"></a>
                            </div>
                        </div>
                    </div>
                </div>
