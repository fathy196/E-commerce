                    ...
                    <div class="e-product">
                        ...
                        <div class="product-collection-grid product-grid product-grid-v2">
                            <div class="row">
                                ...
                                @if($products->isEmpty())
                                <div class="empty-message" style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 50vh; text-align: center;">
                                    <i class="fas fa-box-open" style="font-size: 100px; color: #ccc; margin-bottom: 20px;"></i>
                                    <p style="font-size: 18px; color: #666;">No products available at the moment. Please check back later.</p>
                                </div>
                            @else
